...
contract ZubiDubiDemoTest is AquaSwapVMTest {
    ...
    function test_ZubiDubiDemo_RoutesExitAcrossSolventAquaMakers() public {
        ...
        _assertAquaBalances(unavailableMaker, unavailableHash, 10 ether, 10_000 ether);
        assertEq(usdc.balanceOf(unavailableMaker), 0);
        _assertAquaBalances(makerA, orderHashA, 2 ether, 10_000 ether - 2_970.3 ether);
        _assertAquaBalances(makerB, orderHashB, 3 ether, 10_000 ether - 4_410.9 ether);
        _assertAquaBalances(makerC, orderHashC, 2.5 ether, 10_000 ether - 1_440.45 ether);
