...
| `frontend/src/components/zubi/playground/` | modular playground panels for scenarios, market state, route split, protocol timeline, and proof catalog |
...
| `/playground` | deployable judge cockpit with live Graph markets, solver quotes, route split previews, protocol proof timeline, activity tape, and test-proof catalog |
