...
- **Frontend deployed to Vercel production**: `https://frontend-gamma-jade-96.vercel.app` serves landing, Markets, Sell, Make, Portfolio, and Playground routes from the Vercel build output. Smoke checks returned HTTP 200 for `/`, `/markets`, `/sell`, `/portfolio`, `/make`, and `/playground`; the app is bundled against Subgraph Studio `v0.9.6`.
