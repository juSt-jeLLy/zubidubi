...
- **Shared term-risk budget executor deployed** (2026-09-12): `ZubiDubiRouteExecutor` now lets makers register one global receipt-exposure / quote-spend budget and assign sibling Aqua strategies to it. Quotes are capped by remaining budget, execution consumes budget immediately, The Graph indexes budget setup/use events, and the frontend Make/Portfolio/Playground surfaces show the shared reserve. Sepolia executor: `0x5b9f90FDe93d0284A3a937078D6DDEF678816127`.
...
- Phase 12: `ZubiDubiRouteExecutor` now supports shared maker term-risk budgets. A maker can link sibling Aqua strategies to one `budgetId`, and the router caps quotes/execution by remaining global receipt exposure and quote-token spend so strategies cannot race the same reserve independently. The budget-aware executor is deployed on Sepolia at `0x5b9f90FDe93d0284A3a937078D6DDEF678816127` (tx `0x9a9cd161fdcd37fd61325ca01933464a45b117f456bc6a1e47fb633f263c4e2b`, block `11685467`).
...
Current Sepolia deployment (budget-aware route executor upgrade, 2026-09-12, block 11685467):

- Aqua: `0x30aefbDE9EC52A23E597e338F02f35Da909D7183`.
- AquaSwapVMRouter: `0x3d39B155De93CB9C340577E06b801C4956ed2a57`.
- ZubiDubiRouteExecutor: `0x5b9f90FDe93d0284A3a937078D6DDEF678816127`.
...
- Deploy ZubiDubiRouteExecutor tx: `0x9a9cd161fdcd37fd61325ca01933464a45b117f456bc6a1e47fb633f263c4e2b`.
...
- Live shared-budget proof: budget `0x25df91de3b0b88921665b1290762b8328e4239985cab7fb629b0d44fb642012a` was set in tx `0x6e5834b0de0631053de4c826f74004ef4e2ef4abe4ba25cecf96e1975f9e7815`, then assigned to sibling `PT-zbETH-30D/USDC` and `PT-zbETH-180D/USDC` strategies in txs `0xea55203701d9c1d1a3658c6365ad57b38c95916b855e0fe859e92366e7a4ae14` and `0x941eae836d832dc8f83dd55b4253338a406760a32a062b090efe5e42b1dfc6dd`. Subgraph `v0.9.4` indexes `assignmentCount = 2`, and the live solver quote returns `budgetRemainingIn = 0.006` and `budgetRemainingOut = 50`.
